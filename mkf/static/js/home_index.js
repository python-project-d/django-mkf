...
$(function(){
	...
	$('.swiper-button-prev').click(function(){		
		var i=$('.full-screen-slides-pagination .current').index();
		if(i==0){
			$('.full-screen-slides-pagination  li').last().click();
		}else{
			$('.full-screen-slides-pagination  .current').prev().click();
		}		
		
	});	
	//next
	$('.swiper-button-next').click(function(){	
		var size=$('.full-screen-slides-pagination li').length;
		var i=$('.full-screen-slides-pagination .current').index();
		if(i<(size-1)){
			$('.full-screen-slides-pagination  .current').next().click();
		}else{
			$('.full-screen-slides-pagination  li').first().click();
		}		
